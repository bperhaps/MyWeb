...
<body class="align">
  ...
  <div class="site__container">
	...
	<div class="login-logo" style="color:white; text-align:center">
      ...
      <form action="./lib/register.php" method="POST" class="form form--login">
        ...
        <div class="form__field">
          ...
          <input id="register__username" type="text" name="id" class="form__input" placeholder="Username" required>
        </div>
	...
	<div class="form__field">
	  <label class="fontawesome-home"><span class="hidden">HomeId</span></label>
	  <input id="register_homeid" type="text" name="homeid" class="form__input" placeholder="HomeId" required>
	</div>
